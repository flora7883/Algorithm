...
import java.io.*;
import java.util.*;
class SegmentTreeMin_Beakjoon_10868{
	int[] a;
	int[] tree;
	SegmentTreeMin_Beakjoon_10868(int N, int size){
		a=new int[N];
		tree=new int[size];
...
public class Beakjoon_10868 {
	...
	public static void main(String[] args) {
		...
		SegmentTreeMin_Beakjoon_10868 tree=new SegmentTreeMin_Beakjoon_10868(N,size);
