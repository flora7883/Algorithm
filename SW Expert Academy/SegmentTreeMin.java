class SegmentTreeMin {
	...
	static void update(int node, int start, int end, int index, int newVal ){
	...
	public static void main(String[]args)throws Exception{
		...
		//newVal: 새로운 값, 원래 값은 a배열에 저장되어있음. a[k]값을 newVal로 변경하고 싶으면 
		//a[k]=Math.min(a[k],newVal);
		//update(1,0,n-1,k,newVal)
		
		//a[k1]부터 a[k2]까지의 최솟값을 구하고 싶으면
		//min(1,0,n-1,k1, k2)
	}
}
